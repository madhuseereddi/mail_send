const problems = require('./probelms');  // Importing the problems array
...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    pass: 'wdjn psjv ssba woxz'  // Replace with App Password
  }
});
...
// Schedule the task to run daily at 7:55 PM
schedule.scheduleJob('20 22 * * *', () => {
  console.log('Sending daily coding questions...');
  sendEmail();
});
